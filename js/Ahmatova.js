...
document.querySelectorAll('.book-bg').forEach(function (bookBg, index) {
    bookBg.addEventListener('click', function () {
        ...
        const title = document.getElementById(`add${index + 6}`).innerText;
        const text = document.querySelector(`.p${index + 6}`).innerText;
        const text2 = document.querySelector(`.q${index + 6}`).innerText;
