...
document.querySelectorAll('.book-bg').forEach(function (bookBg, index) {
    bookBg.addEventListener('click', function () {
        ...
        const title = document.getElementById(`add${index + 54}`).innerText;
        const text = document.querySelector(`.p${index + 54}`).innerText;
        const text2 = document.querySelector(`.q${index + 54}`).innerText;
