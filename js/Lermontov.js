...
document.querySelectorAll('.book-bg').forEach(function (bookBg, index) {
    bookBg.addEventListener('click', function () {
        ...
        const title = document.getElementById(`add${index}`).innerText;
        const text = document.querySelector(`.p${index}`).innerText;
        const text2 = document.querySelector(`.q${index}`).innerText;
